<?php /* Smarty version 3.1.27, created on 2023-10-13 14:22:53
         compiled from "/home/multistream6/domains/capicoin.online/public_html/tmpl/home.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:326897174652952bddd0b91_59091624%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6699f61cdfdbbfebc350361047e70be8210f1731' => 
    array (
      0 => '/home/multistream6/domains/capicoin.online/public_html/tmpl/home.tpl',
      1 => 1689600474,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '326897174652952bddd0b91_59091624',
  'variables' => 
  array (
    'SiteName' => 0,
    'userinfo' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_652952bde1c012_63317541',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_652952bde1c012_63317541')) {
function content_652952bde1c012_63317541 ($_smarty_tpl) {
...
$_smarty_tpl->properties['nocache_hash'] = '326897174652952bddd0b91_59091624';
?>

<?php $_smarty_tpl->tpl_vars['SiteName'] = new Smarty_Variable("Capital Coin Investment", null, 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("home_slider.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0);
?>
...
<section class="section section-feature pb-0">
    <div class="container">
        <div class="row g-gs flex-row-reverse justify-content-between align-items-center">
            ...
            <div class="col-lg-5">
                <div class="text-block">
                    <h2 class="title mb-3"><?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['SiteName']->value);?>
 Benefits</h2>
                    <p>Looking for highest returns on your investments? <?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['SiteName']->value);?>
 is an automatic online investment platform, part of <?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['SiteName']->value);?>
 – team of professional traders focusing mainly on Bitcoin and other cryptocurrencies trading over multiple Exchanges and markets.</p>
                ...
                <div class="pricing pricing-s3 pricing-s3-featured card card-shadow card-bordered round-xl">
                    <div class="card-inner card-inner-lg">
                        ...
                        <div class="pricing-action">
                            <a href="<?php if ($_smarty_tpl->tpl_vars['userinfo']->value['logged'] != 1) {?>?a=login<?php } else { ?>?a=deposit<?php }?>" class="btn btn-outline-light btn-lg btn-block"><span>Buy Plan</span></a>
                        </div>
                    </div>
                </div>
            </div><!-- .col -->
    ...
    <div class="container">
        <div class="row align-items-center justify-content-between g-gs">
            ...
            <div class="col-xl-5 col-lg-6">
                <div class="text-block">
                    <h2 class="title fw-medium">At <?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['SiteName']->value);?>
</h2>
        ...
        <div class="row justify-content-center text-center">
            <div class="col-xl-6 col-lg-7 col-md-8">
                <div class="text-block is-compact">
                    <h2 class="title">Get Started Today With <?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['SiteName']->value);?>
</h2>
